...
export default function Login() {
  const login = (provider: LiteralUnion<BuiltInProviderType>) => {
  ...
  return (
    <div className="flex h-screen w-screen flex-row items-center">
      <div className="h-full w-1/2 bg-[url('/logo.png')] bg-cover"></div>
        ...
        <div className="lg:p-8">
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            ...
            <div className="grid gap-6">
              <Button onClick={() => void login("github")}>
              ...
              <Button variant="outline" onClick={() => void login("google")}>
                <svg
                  fill="#000000"
