  ...
  return (
    <div className="-mt-[5.75rem] overflow-hidden pt-[5.75rem]">
      ...
      <div className="container max-w-6xl">
        <p>
          These terms of service (&#34;Terms&#34;) apply to your access and use
          of Wotmaster.com. Please read them carefully.
        </p>
        <h2 className="my-4 text-lg font-bold text-black">
        ...
        <p>
          ...
          <Link href="mailto:info@wotmaster.com" className="text-blue-400">
            info@wotmaster.com
          </Link>
          .
        </p>
        ...
        <p>
          Whenever we make changes to these Terms, the changes are effective 3
          month after we post such revised Terms (indicated by revising the date
          at the top of these Terms) or upon your acceptance if we provide a
          mechanism for your immediate acceptance of the revised Terms (such as
          a click-through confirmation or acceptance button). It is your
          responsibility to check Wotmaster.com for changes to these Terms.
        </p>
        <p>
        ...
        <h2 className="my-4 text-lg font-bold text-black">Privacy Policy</h2>
        <p>
          For information about how we collect and use information about users
          of the Service, please check out our privacy policy available a{" "}
          <Link
            href="https://maytapi.com/legal/privacy"
            className="text-blue-400"
          >
            Wotmaster.com PRIVACY POLICY
          </Link>
          .
        </p>
        <h2 className="my-4 text-lg font-bold text-black">
        ...
        <h2 className="my-4 text-lg font-bold text-black">Creating Accounts</h2>
        <p>
        ...
        <p>
          ...
          Service, you grant us the right and license to use, reproduce, modify,
          publicly perform, publicly display and distribute your content on or
          through the Service. We may format your content for display throughout
          the Service, but we will not edit or revise the substance of your
          content itself.
        </p>
        <p>
        ...
        <p>
          ...
          delete your content, it will not appear on the Service, but copies of
          your deleted content may remain in our system or backups for some
          period of time. We will retain web server access logs for a maximum of
          5 year and then delete them.
        </p>
        <p>
        ...
        <li>
          ...
          rate limits or other features designed to protect the Service, users
          of the Service, or third parties.
        </li>
        <h2 className="my-4 text-lg font-bold text-black">
          Wotmaster.com Materials
        </h2>
        <p>
        ...
        <p>
          ...
          (ii) modifying or otherwise making any derivative uses of the Service
          or any portion thereof; (iii) using any data mining, robots or similar
          data gathering or extraction methods; (iv) downloading (other than
          page caching) of any portion of the Service or any information
          contained therein; (v) reverse engineering or accessing the Service in
          order to build a competitive product or service; or (vi) using the
          Service other than for its intended purposes. If you do any of this
          stuff, we may terminate your use of the Service.
        </p>
        ...
        <p>
          ...
          <b>Wotmaster.com</b> makes no claim or representation regarding, and
          ...
          policies no longer govern. If there is any content on the Service from
          you and others, we don&#39;t review, verify or authenticate it, and it
          may include inaccuracies or false information. We make no
          representations, warranties, or guarantees relating to the quality,
          suitability, truth, accuracy or completeness of any content contained
          in the Service. You acknowledge sole responsibility for and assume all
        ...
        <p>
          ...
          EVENT WILL <b>Wotmaster.com</b>BE LIABLE TO YOU OR ANY THIRD PARTY FOR
          ...
          AMOUNT YOU PAID TO <b>Wotmaster.com</b>. THIS SECTION WILL BE GIVEN
          FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED
          TO HAVE FAILED OF ITS ESSENTIAL PURPOSE. You agree to defend,
          indemnify and hold us harmless from and against any and all costs,
          damages, liabilities, and expenses (including attorney&#39;s fees,
          costs, penalties, interest and disbursements) we incur in relation to,
          arising from, or for the purpose of avoiding, any claim or demand from
          a third party relating to your use of the Service or the use of the
          Service by any person using your account, including any claim that
          your use of the Service violates any applicable law or regulation, or
          the rights of any third party, and/or your violation of these Terms.
        </p>
        <h2 className="my-4 text-lg font-bold text-black">
        ...
        <h2 className="my-4 text-lg font-bold text-black">Termination</h2>
        <p>
          If you breach any of these Terms, we have the right to suspend or
          disable your access to or use of the Service.
        </p>
        <h2 className="my-4 text-lg font-bold text-black">Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between you and{" "}
          <b>Wotmaster.com</b> regarding the use of the Service, superseding any
          prior agreements between you and <b>Wotmaster.com</b> relating to your
          use of the Service.
        </p>
        <h2 className="my-4 text-lg font-bold text-black">Feedback</h2>
        <p>
          Please let us know what you think of the Service, these Terms and, in
          general, Wotmaster.com. When you provide us with any feedback,
          comments or suggestions about the Service, these Terms and, in
          general, Wotmaster.com, you irrevocably assign to us all of your
          right, title and interest in and to your feedback, comments and
          suggestions.
        </p>
        <h2 className="my-4 text-lg font-bold text-black">
